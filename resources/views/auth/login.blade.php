      ...
      <div class="login-area">
        ...
        <form method="POST" action={{ route('login_action') }}>
          ...
          <div class="email-area">
            ...
            <input type="email" name="email" placeholder="Digite o seu e-mail" value="{{ $email ?? '' }}" />
            @error('email')
                <div class="error">
                    {{ $message }}
                </div>
          ...
          <div class="password-area">
            ...
            <x-form.password-input name="password" placeholder="Digite sua senha" id="password" />
                @error('password')
                    <div class="error">
                        {{ $message }}
                    </div>
