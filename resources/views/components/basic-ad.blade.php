...
<a href="{{ route('ad.show', $ad->slug) }}" class="my-ad-item" style="text-decoration: none;">
    ...
    <div class="ad-image-area">
        ...
        @endif
        <div class="ad-image" style="background-image: url('{{ $ad->images->where('featured', 1)->first()->url ?? 'https://dummyjson.com/image/400x300/FFFFFF/000000?text=Sem+imagem' }}')"></div>
    </div>
